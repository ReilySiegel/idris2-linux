...
int li_posix_spawn (const char *pth, const posix_spawn_file_actions_t *file_actions,
...
int li_posix_spawnp (const char *pth, const posix_spawn_file_actions_t *file_actions,
                     const posix_spawnattr_t *attr, char *const args[],
                     char *const env[]) {
  pid_t pid;
